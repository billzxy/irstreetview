...
export const getPanoCoordById = (id: string) =>
	Promise.resolve({
		data: { data: getDataFromJSONArray(typedPanos, ["coord"], id) }
	});
//export const getAllPanoIdAndCoord = () => Promise.resolve({ data: { data: getDataFromJSON(typedPanos,["id", "coord"]) } })
export const getAllPanoIdAndCoord = () =>
	Promise.resolve({ data: { data: typedPanos } });
...
export const getPanoFileNameById = (id: string) =>
	Promise.resolve({
		data: { data: getDataFromJSONArray(typedPanos, ["filename"], id) }
	});
